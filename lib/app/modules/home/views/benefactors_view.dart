          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Expanded(
                  child: Obx(() {
                    final totalItems = controller.sponsorsData.length;
                    final totalPages = (totalItems / itemsPerPage).ceil();
                    final pageController = PageController(initialPage: currentPage.value);

                    // Sync pageController with currentPage
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: CachedNetworkImage(
                                                ...
                                                dotenv.getBool('LIVE_MODE') == false
                                                    ? "https://playground.askfoundations.org/backend/api/v1/${data?.image}"
                                                    : "https://askfoundations.org/${data?.image}",
